...
void genShape()
{
    if (!gotShape)
    {
        ...
        int J[4][2] = {{3, 4}, {1, 0}, {-1, 0}, {1, -1}};
        int L[4][2] = {{3, 4}, {1, 0}, {-1, 0}, {1, 1}};
        int S[4][2] = {{3, 4}, {1, 0}, {-1, 0}, {-1, -1}};
        int Z[4][2] = {{3, 4}, {-1, 0}, {-1, 0}, {1, -1}};
        int T[4][2] = {{3, 4}, {1, 0}, {-1, 0}, {0, -1}};
        int O[4][2] = {{3, 4}, {-1, 0}, {1, 0}, {-1, -1}};
        int I[4][2] = {{3, 4}, {0, 1}, {0, -1}, {0, -2}};
...
void alterShape(int req)
{
    ...
    case 2: // Move downwards
        ...
        { // Check for each section of the shape
            if (stableMemory[shapeCoordinates[i][0] + 1][0] == 1 || shapeCoordinates[i][0] + 1 == checkingHeight - 1)
